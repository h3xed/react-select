(function (global, factory) {
  ...
  */
  ...
  var Menu = function Menu(props) {
    ...
    var cn = cx( /*#__PURE__*/emotion.css(getStyles('menu', props)), {
      menu: true
    }, className);
  ...
  var MenuPortal = /*#__PURE__*/function (_Component2) {
    ...
    _createClass(MenuPortal, [{
      ...
      value: function render() {
        ...
        var menuWrapper = /*#__PURE__*/React__default.createElement("div", {
          className:
          /*#__PURE__*/
  ...
  var ScrollBlock = /*#__PURE__*/function (_PureComponent) {
    ...
    _createClass(ScrollBlock, [{
      ...
      value: function render() {
        ...
        }), /*#__PURE__*/React__default.createElement(NodeResolver, {
          innerRef: this.getScrollTarget
        }, children), touchScrollTarget ? /*#__PURE__*/React__default.createElement(ScrollLock, {
  ...
  var ScrollCaptorSwitch = /*#__PURE__*/function (_Component2) {
    ...
    _createClass(ScrollCaptorSwitch, [{
      ...
      value: function render() {
        ...
        return isEnabled ? /*#__PURE__*/React__default.createElement(ScrollCaptor, props) : this.props.children;
      }
    }]);
  ...
  var DropdownIndicator = function DropdownIndicator(props) {
    var children = props.children,
        ...
        getStyles = props.getStyles,
        innerProps = props.innerProps;
    return /*#__PURE__*/React__default.createElement("div", _extends({}, innerProps, {
      className: cx( /*#__PURE__*/emotion.css(getStyles('dropdownIndicator', props)), {
        'indicator': true,
        'dropdown-indicator': true
      }, className)
    }), children || /*#__PURE__*/React__default.createElement(DownChevron, null));
  };
  ...
  var ClearIndicator = function ClearIndicator(props) {
    ...
    }), children || /*#__PURE__*/React__default.createElement(CrossIcon, null));
  }; // ==============================
  // Separator
  // ==============================
  ...
  var IndicatorSeparator = function IndicatorSeparator(props) {
    var className = props.className,
        ...
        getStyles = props.getStyles,
        innerProps = props.innerProps;
    return /*#__PURE__*/React__default.createElement("span", _extends({}, innerProps, {
      className: cx( /*#__PURE__*/emotion.css(getStyles('indicatorSeparator', props)), {
  ...
  var LoadingIndicator = function LoadingIndicator(props) {
    ...
    }), /*#__PURE__*/React__default.createElement(LoadingDot, {
      color: color,
      delay: 0,
      offset: isRtl
    }), /*#__PURE__*/React__default.createElement(LoadingDot, {
  ...
  var _excluded$3 = ["className", "cx", "getStyles", "theme", "selectProps"];
  ...
  var Group = function Group(props) {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      className: cx( /*#__PURE__*/emotion.css(getStyles('group', props)), {
        'group': true
      }, className)
    }, /*#__PURE__*/React__default.createElement(Heading, _extends({}, headingProps, {
      selectProps: selectProps,
      theme: theme,
      getStyles: getStyles,
      cx: cx
    }), label), /*#__PURE__*/React__default.createElement("div", null, children));
  };
  ...
  var GroupHeading = function GroupHeading(props) {
    var className = props.className,
        ...
        theme = props.theme,
        selectProps = props.selectProps,
        cleanProps = _objectWithoutProperties(props, _excluded$3);

    return /*#__PURE__*/React__default.createElement("div", _extends({
      className: cx( /*#__PURE__*/emotion.css(getStyles('groupHeading', _objectSpread2({
        theme: theme
      }, cleanProps))), {
        'group-heading': true
      }, className)
  ...
  var _excluded$4 = ["className", "cx", "getStyles", "innerRef", "isHidden", "isDisabled", "theme", "selectProps"];
  ...
  var Input = function Input(_ref2) {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      ...
      /*#__PURE__*/
      emotion.css(getStyles('input', _objectSpread2({
        theme: theme
      }, props)))
    }, /*#__PURE__*/React__default.createElement(AutosizeInput, _extends({
      className: cx(null, {
        'input': true
      }, className),
      inputRef: innerRef,
  ...
  var MultiValueGeneric = function MultiValueGeneric(_ref4) {
    ...
    return /*#__PURE__*/React__default.createElement("div", innerProps, children);
  };
  ...
  var MultiValueRemove = /*#__PURE__*/function (_Component) {
    ...
    _createClass(MultiValueRemove, [{
      ...
      value: function render() {
        ...
        return /*#__PURE__*/React__default.createElement("div", innerProps, children || /*#__PURE__*/React__default.createElement(CrossIcon, {
          size: 14
        }));
      }
    }]);
  ...
  var MultiValue = /*#__PURE__*/function (_Component2) {
    ...
    _createClass(MultiValue, [{
      ...
      value: function render() {
        ...
        var containerInnerProps = _objectSpread2({
        ...
        var removeInnerProps = _objectSpread2({
    ...
    _createClass(Select, [{
      ...
      value: function renderInput() {
        ...
        if (!isSearchable) {
          ...
          return /*#__PURE__*/React__default.createElement(DummyInput, {
            id: id,
      ...
      value: function renderMenu() {
        ...
        if (this.hasOptions()) {
          menuUI = menuOptions.render.map(function (item) {
            if (item.type === 'group') {
              var type = item.type,
                  group = _objectWithoutProperties(item, _excluded$5);
          ...
          menuUI = /*#__PURE__*/React__default.createElement(LoadingMessage$$1, commonProps, message);
        } else {
          ...
          menuUI = /*#__PURE__*/React__default.createElement(NoOptionsMessage$$1, commonProps, _message);
        }
        ...
        var menuElement = /*#__PURE__*/React__default.createElement(MenuPlacer, _extends({}, commonProps, menuPlacementProps), function (_ref6) {
          var ref = _ref6.ref,
              _ref6$placerProps = _ref6.placerProps,
              placement = _ref6$placerProps.placement,
              maxHeight = _ref6$placerProps.maxHeight;
          return /*#__PURE__*/React__default.createElement(Menu$$1, _extends({}, commonProps, menuPlacementProps, {
            innerRef: ref,
            innerProps: {
          ...
          }, /*#__PURE__*/React__default.createElement(MenuList$$1, _extends({}, commonProps, {
        ...
        return menuPortalTarget || menuPosition === 'fixed' ? /*#__PURE__*/React__default.createElement(MenuPortal$$1, _extends({}, commonProps, {
  ...
  var _excluded$6 = ["defaultInputValue", "defaultMenuIsOpen", "defaultValue"];
  var defaultProps$1 = {
    defaultInputValue: '',
      ...
      _createClass(Async, [{
        ...
        value: function render() {
          ...
          var _this$props2 = this.props,
              ...
              props = _objectWithoutProperties(_this$props2, _excluded$7);
  ...
  var defaultProps$3 = _objectSpread2({
